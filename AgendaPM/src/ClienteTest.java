...
public class ClienteTest {
	...
	/**
	 * Instancia a classe e cria exemplos para fazer o teste
	 */
	...
	/**
	 * Metodo que testa a funcionalidade da classe cliente
	 */
	@Test
	public void testCliente() {
		cliente.addProduto(prod);
		cliente.getListaProdutos();
		assertEquals(1, cliente.getListaProdutos().size());
