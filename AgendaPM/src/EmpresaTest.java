...
public class EmpresaTest {
	...
	/**
	 * Cria instancia das classes para testar a criação de uma empresa
	 */
	...
	Empresa Mercedes = new Empresa("Mercedes", "0001-4567", adress);
	Endereco adress5 = new Endereco("Rua5Test", 250, "StEfigenia", "Belo Horizonte", "MG", "35847-000");

	/**
	 * Metodo que testa a criação de empresa
	 */

	@Test
	public void testEmpresaGetClient() {
		cliente.cadastrarCliente(cliente2);
		assertEquals(2, cliente.getCliente("0001-000678").getId());
