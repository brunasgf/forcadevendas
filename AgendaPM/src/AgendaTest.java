...
public class AgendaTest {
	/**
	 * Intancia a classe e cria exemplos de cadastros
	 */
	...
	/**
	 * Metodo que testa a funcionalidade da classe agendas
	 */

	@Test
	public void testAtdVendedor() {
		String qtDias;
		qtDias = agenda.atdVendedor(seller3);
		assertEquals("", qtDias);
	}
